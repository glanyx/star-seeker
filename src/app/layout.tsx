...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <div className="relative grid grid-rows-[20px_1fr_20px] alignjustify-items-center min-h-screen p-0 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
